...
import org.vt.component.VTSearchComponent;
 ...
 * 
 */
public class VisualTableSearchDemo {
    private JVisualTable table = new JVisualTable(new VisualTableModel(
	    SimpleBean.class));

    private JFrame createFrame() {
	JFrame frame = new JFrame("Search Table Demo");
    ...
    private JPanel createSearchPanel(JVisualTable table) {
	JPanel panel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
	panel.add(new VTSearchComponent(table));
	return panel;
    }
	...
	frame.getContentPane()
		.add(createSearchPanel(table), BorderLayout.NORTH);
	...
	new VisualTableSearchDemo().showDemo();
